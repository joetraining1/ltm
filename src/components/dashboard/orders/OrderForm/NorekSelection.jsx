...
import { addNorek } from "../../../../redux/slices/adminOFSlice";

const NorekSelection = () => {
  ...
  const getType = async () => {
    setIsLoading(true);
    const reqType = await ApiClient.get("account").then((res) => {
      return res.data;
    });
  ...
  return (
    ...
    >
      <AccountBalanceWalletRoundedIcon sx={{ color: colorHex.iconColor }} />
      <Divider
